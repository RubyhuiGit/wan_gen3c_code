...
from ..models.wan_control_adaptor import SimpleAdapter


class WanVideo3dCachePipeline(BasePipeline):
    ...
    def __init__(self, device="cuda", torch_dtype=torch.float16, tokenizer_path=None):
        ...
        self.control_adaptor: SimpleAdapter = None
    ...
    def from_model_manager(model_manager: ModelManager, torch_dtype=None, device=None, use_usp=False):
        ...
        pipe = WanVideo3dCachePipeline(device=device, torch_dtype=torch_dtype)
    ...
    def init_control_adaptor(self, input_dim=64, out_dim=5120):
        patch_size = self.dit.patch_size   # [1, 2, 2]
        self.control_adaptor = SimpleAdapter(input_dim, out_dim, patch_size[1:], patch_size[1:])
        self.control_adaptor.train()
        self.control_adaptor.requires_grad_(True)
    
    def denoising_model(self):
        return self.dit
    
    def get_control_adaptor(self):
        return self.control_adaptor
